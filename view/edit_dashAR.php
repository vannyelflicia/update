                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editar as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" value="<?php echo $r->no_faktur_ship ?>" name="no_faktur_ship">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" value="<?php echo $r->no_faktur_ship2 ?>" name="no_faktur_ship2">
